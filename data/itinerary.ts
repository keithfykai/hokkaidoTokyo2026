...
export const itineraryDays: ItineraryDay[] = [
  ...
  },
  {
    ...
    title: "To Tokyo",
    region: "Tokyo",
    summary: "Fly from New Chitose to Haneda, settle into Ikebukuro, and start the Tokyo chapter with Pokémon shopping.",
    hotel: "Hotel Metropolitan Tokyo Ikebukuro",
    hotelMapUrl: mapsSearch("Hotel Metropolitan Tokyo Ikebukuro"),
    stops: [
      {
        title: "New Chitose Airport",
        note: "Eat breakfast, check out, and head to the airport for the Tokyo flight.",
        mapUrl: mapsSearch("New Chitose Airport"),
        kind: "travel",
      },
      {
        title: "Haneda Airport",
        note: "Land in Tokyo and continue to Ikebukuro.",
        mapUrl: mapsSearch("Haneda Airport Tokyo"),
        kind: "travel",
      },
      {
        title: "Hotel Metropolitan Tokyo Ikebukuro",
        note: "Check in and freshen up.",
        mapUrl: mapsSearch("Hotel Metropolitan Tokyo Ikebukuro"),
        kind: "hotel",
      },
      {
        title: "Ikebukuro",
        note: "Explore the area and visit the Pokémon Store.",
        mapUrl: mapsSearch("Pokemon Center Ikebukuro Tokyo"),
        kind: "shopping",
      },
    ],
  },
  {
    ...
    title: "Tokyo Day 2",
    region: "Tokyo",
    summary: "Outlet shopping at Gotemba, then an evening in Ginza for Montbell and dinner.",
    hotel: "Hotel Metropolitan Tokyo Ikebukuro",
    hotelMapUrl: mapsSearch("Hotel Metropolitan Tokyo Ikebukuro"),
    stops: [
      {
        title: "Gotemba Premium Outlets",
        note: "Take the bus out for shopping and lunch.",
        mapUrl: mapsSearch("Gotemba Premium Outlets"),
        kind: "shopping",
      },
      {
        title: "Hotel Metropolitan Tokyo Ikebukuro",
        note: "Bus back, drop off shopping, and freshen up.",
        mapUrl: mapsSearch("Hotel Metropolitan Tokyo Ikebukuro"),
        kind: "hotel",
      },
      {
        title: "Ginza",
        note: "Shop at Montbell, have dinner, then return to rest.",
        mapUrl: mapsSearch("Montbell Ginza Tokyo"),
        kind: "shopping",
      },
    ],
  },
  {
    ...
    title: "Tokyo Day 3",
    region: "Tokyo",
    summary: "Asakusa temples and Kappabashi kitchenware before Shinjuku shopping.",
    hotel: "Hotel Metropolitan Tokyo Ikebukuro",
    hotelMapUrl: mapsSearch("Hotel Metropolitan Tokyo Ikebukuro"),
    stops: [
      {
        title: "Sensō-ji Temple and Asakusa",
        note: "Explore the temple and surrounding streets.",
        mapUrl: mapsSearch("Sensoji Temple Asakusa Tokyo"),
        kind: "sightseeing",
      },
      {
        title: "Kappabashi Street",
        note: "Shop for kitchenware and knives, then eat lunch nearby.",
        mapUrl: mapsSearch("Kappabashi Street Tokyo"),
        kind: "shopping",
      },
      {
        title: "Shinjuku",
        note: "Shop at BEAMS and Alpen, have dinner, then return to rest.",
        mapUrl: mapsSearch("BEAMS Shinjuku Alpen Tokyo"),
        kind: "shopping",
      },
    ],
  },
  {
    ...
    title: "Tokyo Day 4",
    region: "Tokyo",
    summary: "Omotesando, Harajuku, Cat Street, Shibuya, and Miyashita Park.",
    hotel: "Hotel Metropolitan Tokyo Ikebukuro",
    hotelMapUrl: mapsSearch("Hotel Metropolitan Tokyo Ikebukuro"),
    stops: [
      {
        title: "Omotesando",
        note: "Start the day shopping and walking toward Harajuku.",
        mapUrl: mapsSearch("Omotesando Tokyo"),
        kind: "shopping",
      },
      {
        title: "Harajuku and Cat Street",
        note: "Lunch, then walk Cat Street toward Shibuya.",
        mapUrl: mapsSearch("Cat Street Harajuku Tokyo"),
        kind: "sightseeing",
      },
      {
        title: "Shibuya",
        note: "Shop around Shibuya, then dinner and more browsing at Miyashita Park Mall.",
        mapUrl: mapsSearch("Miyashita Park Shibuya Tokyo"),
        kind: "shopping",
      },
    ],
  },
  {
    ...
    title: "Tokyo Day 5",
    region: "Tokyo",
    summary: "Meet Ben and Xin Ying for a day trip to Kamakura.",
    hotel: "Hotel Metropolitan Tokyo Ikebukuro",
    hotelMapUrl: mapsSearch("Hotel Metropolitan Tokyo Ikebukuro"),
    stops: [
      {
        title: "Meet Ben and Xin Ying",
        note: "Link up before heading out for the day.",
        mapUrl: mapsSearch("Hotel Metropolitan Tokyo Ikebukuro"),
        kind: "activity",
      },
      {
        title: "Kamakura",
        note: "Day trip from Tokyo.",
        mapUrl: mapsSearch("Kamakura Japan"),
        kind: "sightseeing",
      },
    ],
  },
  {
    ...
    region: "Tokyo",
    summary: "Check out, take the highway bus to the airport, and fly back to Singapore.",
    stops: [
      {
        title: "Hotel Metropolitan Tokyo Ikebukuro",
        note: "Eat breakfast and check out.",
        mapUrl: mapsSearch("Hotel Metropolitan Tokyo Ikebukuro"),
        kind: "hotel",
      },
      {
        title: "Airport highway bus",
        note: "Book in advance and head to the airport.",
        mapUrl: mapsSearch("airport limousine bus Ikebukuro Tokyo"),
        kind: "travel",
      },
      {
        title: "Flight to Singapore",
        note: "Depart Tokyo for Singapore.",
        mapUrl: mapsSearch("Tokyo airport Singapore flight"),
        kind: "travel",
      },
    ],
  },
